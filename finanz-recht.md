...
## 0. Das Kernproblem: Wer ist der Rechnungssteller?
...
## 1. Erst die Art des Sponsorings klären

| | **Echtes Sponsoring** | **Unechtes Sponsoring (Spende)** |
|---|---|---|
| Gegenleistung | Werbung/Logo/Plakat (das ihr anbietet) | keine |
| Steuerlich | steuerpflichtiger **Umsatz** → Rechnung (Kleinunternehmer: ohne USt) | **keine Rechnung**, nur Spendenbestätigung |
| Sponsor kann | als **Betriebsausgabe** absetzen | nur sehr eingeschränkt (nur bei spendenbegünstigter Einrichtung) |

Da ihr Sponsoren **Werbung als Gegenleistung** gebt (Banner, Logo auf Website/Social/Beamer), ist das **echtes Sponsoring** → es braucht eine ordentliche Rechnung. Genau das wollen die Firmen, um es steuerlich absetzen zu können.
...
UID/USt-ID: keine (Kleinunternehmer)
...
Leistung: Sponsoring SunDowner — Werbepräsenz (Logo auf Website/Social, Beamer-Lauf,
Banner vor Ort) am 25.09.2026, Am Tabor, Neusiedl am See
...
| Posten | Kosten |
|--------|--------|
| Anzeige der Vereinserrichtung (Bundesgebühr) | **21,00 €** |
